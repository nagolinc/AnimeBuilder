...
def get_track_by_tags(tags, pat, duration, maxit=20, autoplay=False, loop=False):
  ...
  for i in range(maxit):
      ...
      if r.status_code == 200:
          ...
          #return Audio(trackurl, autoplay=autoplay)
          return trackurl
          break
      time.sleep(1)
      print('.', end='')
...
pat="dHRtLjE3MjAxMDg2LjQ5NTFmNjQyOGU4MzE3MmE0ZjM5ZGUwNWQ1YjNhYjEwZDU4NTYwYjguMS4z.de77bfc7a088dcfae1adb8a2fddcb1d895f4bb11633e2bd12e6012c717248496"
