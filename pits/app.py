...
def parsearg():
    ...
    parser.add_argument('-c',
                        '--config',
                        type=str,
                        default="./pits/configs/config_en.yaml",
    ...
    parser.add_argument('-r',
                        '--checkpoint_path',
                        type=str,
                        default='./pits/logs/pits_vctk_AD_3000.pth',
...
def get_default_args():
    ...
    default_args.config = "./pits/configs/config_en.yaml"
    default_args.model = "PITS"
    default_args.checkpoint_path = "./pits/logs/pits_vctk_AD_3000.pth"
    default_args.force_resume = None
    default_args.dir = "/DATA/audio/pits_samples"
